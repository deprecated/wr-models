...
#+BEGIN_SRC python :results file :return pltfile :tangle TimeCloudy/wr-multi-shock-plot.py
  ...
  fig_cum, [
      ...
      axOcharge_cum,
      axT_cum,
  ] = plt.subplots(6, 1, sharex=True, figsize=(6, 10))
  ...
  for row, c in reversed(list(zip(models[:-1], colors))):
      ...
      ax5007_cum.plot(cumem, em5007, label=tlabel, color=c)
      ax4363_cum.plot(cumem, em4363/em5007, color=c)
      axLc_cum.plot(cumem, Lcool, color=c)
      axO3frac_cum.plot(cumem, em5007/Lcool, color=c)
      axOcharge_cum.plot(cumem, Ocharge, color=c)
  ...
  axT_cum.set_ylim(0.0, 5e4)
  ax5007_cum.legend(ncol=2, fontsize='x-small', loc='lower right')
  axT_cum.set_xlabel('Fraction of cumulative [O III] 5007 emission')
