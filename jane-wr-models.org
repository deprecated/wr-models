...
#+BEGIN_SRC python :results file :return pltfile
  ...
  fig_em, axes_em = plt.subplots(6, 1, sharex=True)
  fig_em.set_size_inches(6, 12)
  ax6563, ax4363, ax5007, axLcool, ax5007frac, axOcharge = axes_em
  ...
  for row, c in zip(models[:-1], colors):
      ...
      ax5007.plot(ss, em5007, label=label, color=c)
      ax4363.plot(ss, em4363/em5007, color=c)
      ax6563.plot(ss, em5007/em6563, color=c)
  ...
  ax6563.set_ylabel('[O III] 5007/Hα ratio')
  ax5007.legend(ncol=2, fontsize='x-small', loc='upper left')
  ...
  for ax in axes_em:
      ax.set_xscale('log')
      ax.set_yscale('log')
      ax.set_xlim(1e-6, 1.5)
  ax5007.set_ylim(3e-25, 1.5e-20)
  ax6563.set_ylim(0.1, 150)
